...
public class JsonRpcServer extends JsonRpcBasicServer {
	 ...
	 */
	public void handle(ResourceRequest request, ResourceResponse response) throws IOException, NoSuchMethodException {
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			...
			if (StreamEndedException.class.isInstance(t)) {
				...
				byteOutput.write("Bad request: empty contents!".getBytes());
				contentLength = byteOutput.size();
				result = ErrorResolver.JsonError.OK.code;
			} else {
	...
	private int handleRequest0(InputStream input, OutputStream output, String contentEncoding, HttpServletResponse response, ByteArrayOutputStream byteOutput) throws IOException, NoSuchMethodException {
		int result;
