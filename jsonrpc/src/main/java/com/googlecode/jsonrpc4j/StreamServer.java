...
/**
 * A multi-threaded streaming service that uses JSON-RPC over sockets.
 */
...
public class StreamServer {
	 ...
	 * @param maxThreads    the mac number of threads the service will spawn
		...
		public void run() {
			...
			while (StreamServer.this.keepRunning.get()) {
				try {
					...
					// spawn a new Server for the next connection and break out of the service loop
					executor.submit(new Server());
					break;
